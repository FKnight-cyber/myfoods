...
async function addProduct(req, res) {
    ...
    const { name, image, category, description, quantity, price, hasEdge } = req.body;
    await productService_1.default.addProduct(name, image, category, description, quantity, price, hasEdge, userInfo.data);
    res.sendStatus(201);
}
